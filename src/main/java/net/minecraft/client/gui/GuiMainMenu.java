...
import me.eternadox.client.impl.ui.altmanager.GuiAltManager;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        DrawUtil.drawImage(new ResourceLocation("blahajhack/images/boykisser.png"), 0, 0, this.width, this.height);

        int i = 136;
        int j = this.width / 2 - i / 2;
        int k = 30;

        DrawUtil.drawImage(new ResourceLocation("blahajhack/images/blahaj.png"), j, k, 136, 81);
        this.drawString(this.fontRendererObj, message, 2, this.height - 10, -1);
