...
public class Main
{
    private static String[] cars = {"AudiA6", "KiaSoul", "HondaCivic", "VWBeetle", "VWFox","KiaOptima","HyundaiIX35","JeepWrangler","VolvoV40","GMCTerrain","NissanAltima","FordFusion","FordFocus","FordF150","BmwX1","LexusES"};
    public static void main(String[] p_main_0_)
    {
        ...
        OptionSpec<String> optionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo(random.ints(1989, 2020).findFirst().getAsInt() + cars[random.nextInt(cars.length)], new String[0]);
