...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdateWalkingPlayer()
    {
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(event.getX(), -999.0D, event.getZ(), event.getYaw(), event.getPitch(), event.isOnGround()));
                flag2 = false;
            }
            ...
            Client.INSTANCE.getBus().post(event1);
