...
import me.eternadox.client.impl.event.Event3DRender;
import me.eternadox.client.impl.module.combat.Reach;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            {
                Reach reachModule = (Reach)Client.INSTANCE.getModuleManager().getModule("Reach");

                if (reachModule.isToggled()) {
                    d1 = reachModule.getReach();
                }
            }
            ...
            Vec3 vec33 = null;
            float f = 1.0F;
            List<Entity> list = this.mc.theWorld.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand((double)f, (double)f, (double)f), Predicates.and(EntitySelectors.NOT_SPECTATING, new EntityRenderer1(this)));
            double d2 = d1;
        ...
        if (Reflector.EntityViewRenderEvent_CameraSetup_Constructor.exists())
        {
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                if (entity instanceof EntityAnimal)
                {
                    ...
                    f7 = entityanimal.prevRotationPitchHead + (entityanimal.rotationPitchHead - entityanimal.prevRotationPitchHead) * partialTicks + 180.0F;
    ...
    private void renderWorldPass(int pass, float partialTicks, long finishTimeNano)
    {
        ...
        Event3DRender event3DRender = new Event3DRender(partialTicks);
        Client.INSTANCE.getBus().post(event3DRender);
