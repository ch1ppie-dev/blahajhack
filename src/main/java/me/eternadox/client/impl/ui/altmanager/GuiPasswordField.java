...
public class GuiPasswordField extends Gui
{
    ...
    public GuiPasswordField(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height, String prefix)
    {
        this.id = componentId;
    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (s.length() > 0)
            {
                ...
                j1 = this.fontRendererInstance.drawStringWithShadow(this.prefix + s1, (float)l, (float)i1, i);
            }
